  ...
  return (
    <div className="App">
      <header className="sticky-header">
        <h1 className="brand_name">Geeksforgeeks Job Search Portal</h1>
        <nav>
          <ul>
            <li>
              <a href="#">Home</a>
      ...
      <div className="content-container">
        <section className="job-listings">
          ...
          {loading ? (
            ...
            <h2 className="No_job_avilable">No jobs available</h2>
          ) : noMatch ? (
            <h2 className="No_job">No matching job found</h2>
          ) : (
            filteredJobs.map((job) => (
              ...
              >
                ...
                <p className="loaction">Location: {job.location}</p>
